            ...
            for id ,lm in enumerate(hand_landmark.landmark):
             ...
             #Code goes here
                for tip in finger_tips:
                    ...
                    x,y = init(lm_list[tip].x*w), init(lm_list[tip].y*h)
                    ...
                    if lm_list[tip].x < lm_list[tip - 3].x:
                        ...
                        if all(finger_fold_status):
                            #checking if the thum is up
                            if lm_list[thum_tip].y < lm_list[thum_tip-1].y < lm_list[thum_tip-2].y:
                                print("LIKE")
                                cv2.putText(img, "LIKE", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 3)

                                #checking if the thum is down
                                if lm_list[thum_tip].y > lm_list[thum_tip-1].y > lm_list[thum_tip-2].y:
                                    print("DISLIKE")
